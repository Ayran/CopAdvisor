...
/*Classe responsável em gerar a view que ira exibir as informações do estádio escolhido pelo usuário*/


public class EstadioTamplateActivity extends Activity {
	...
	public void getMensage(String title,String mensage){
    	 ...
    	 AlertDialog.Builder mensagem = new AlertDialog.Builder(EstadioTamplateActivity.this);
